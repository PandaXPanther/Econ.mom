  ...
  return (
    <PageShell>
      <SEO
        ...
        description="Full methodology and primary sources behind each of The Mother Of Econ's eight tools — College Board rubrics, USITC elasticities, FRED series, Taylor rule variants, NBER papers, and Colorado state data."
        path="/methodology"
      />
