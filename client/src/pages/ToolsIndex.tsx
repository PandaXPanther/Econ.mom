...
export default function ToolsIndex() {
  return (
    <PageShell>
      <SEO
        title="All eight tools — the complete library | The Mother Of Econ"
        description="Every instrument in the econ.mom library: AP FRQ Grader, TariffLab, Textbook Atlas, Shock Simulator, Shadow Fed, Paper Decoder, Extemp Engine, Colorado Econ Dashboard."
        path="/tools"
      />
